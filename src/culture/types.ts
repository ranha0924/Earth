...
export const RELIGIONS: ReligionInfo[] = [
  {
    ...
    distribution: '남유럽·라틴아메리카·필리핀. 유럽의 식민 활동을 따라 라틴아메리카 전역으로 퍼졌다.',
    linkPoint:
  ...
  },
  {
    ...
    architecture:
      '양파 모양의 황금 돔과 이콘(성화)으로 화려하게 꾸민 정교회 성당. 러시아의 양파 돔 성당이 대표적이다.',
    lifestyle:
  ...
  },
  {
    ...
    lifestyle:
      '소를 신성하게 여겨 쇠고기를 먹지 않고, 갠지스강에서 목욕하며 몸을 정화한다. 전통적으로 카스트(신분)에 따라 생활했고, 색의 축제 홀리와 빛의 축제 디왈리를 지낸다.',
    distribution: '인도·네팔 중심의 남부아시아.',
    linkPoint:
      '힌두교의 소 신성시와 카스트 전통이 인도 문화권의 생활에 큰 영향을 주었다. 대표 축제 홀리가 인도 문화권을 상징한다.',
  },
  {
    id: 'buddhist',
    nameKo: '불교',
  ...
  },
  {
    ...
    overview:
      '유일신을 믿는 가장 오래된 일신교의 하나. 유대인을 신이 택한 민족으로 믿으며, 경전은 토라(모세오경)를 중심으로 한다. 크리스트교·이슬람교의 뿌리가 됐다.',
    architecture:
    ...
    linkPoint:
      '유대교 → 크리스트교 → 이슬람교로 이어지는 일신교의 뿌리. 오늘날 팔레스타인 지역을 둘러싼 영토·정치적 갈등이 이어진다.',
  },
  {
    id: 'other',
    nameKo: '기타·토속·무종교',
