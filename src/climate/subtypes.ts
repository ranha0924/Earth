...
export const SUBTYPE: Record<ClimateId, SubtypeInfo> = {
  ...
  Am: {
    ...
    cause: '계절풍(몬순)의 방향이 계절마다 바뀌어 비가 몰리는 우기와 짧은 건기가 나타난다.',
  ...
  Aw: {
    ...
    cause: '적도 저압대(우기)와 아열대 고압대(건기)가 계절에 따라 번갈아 영향을 주어 우기·건기가 뚜렷하다.',
  ...
  BS: {
    ...
    cause: '아열대 고압대 언저리나 바다에서 먼 내륙에 있어 비가 적다(사막보다는 조금 많음).',
  ...
  BW: {
    ...
    cause: '아열대 고압대의 하강 기류(사하라)나 바다에서 먼 내륙·한류가 흐르는 연안이라 극도로 건조하다.',
  ...
  Cfa: {
    ...
    cause: '대륙 동안에 위치하고 계절풍의 영향을 받아 여름이 고온다습하고 강수가 여름에 많다.',
  ...
  Cfb: {
    ...
    cause: '편서풍과 난류(북대서양 해류)의 영향으로 위도에 비해 겨울이 온화하고 연중 강수가 고르다.',
  ...
  Cs: {
    ...
    cause: '여름엔 아열대 고압대에 들어 덥고 건조하고, 겨울엔 편서풍대에 들어 비가 온다.',
  ...
  Dw: {
    ...
    cause: '고위도 대륙 동안이라 겨울에 시베리아(대륙) 고기압의 영향으로 몹시 춥고 건조하며 연교차가 크다.',
    vegetation: '침엽수림(타이가).',
    life: '겨울이 매우 춥고 건조하며 연교차가 크다. 임업과 짧은 여름 밭농사가 이루어진다. 시베리아 동부·중국 동북부가 대표적이다.',
  },
  ET: {
    ko: '툰드라', group: '한대', color: '#cbbde0', // 옅은 보라
    cause: '고위도라 햇빛을 비스듬히 약하게 받아 가장 따뜻한 달도 0~10℃에 그친다.',
  ...
  EF: {
    ...
    cause: '극지방이라 일사가 매우 약해 가장 따뜻한 달도 영하이고 연중 눈·얼음으로 덮인다.',
    vegetation: '연중 눈과 얼음으로 덮여 식생이 거의 없다.',
    life: '사람이 정착하기 어려워 남극 세종·장보고 과학 기지처럼 연구·탐사 목적의 시설이 중심이다.',
  },
  H: {
    ko: '고산', group: '고산', color: '#2a2a2a', hatch: true, // 검은 빗금 (고산 관례 표기 — 범례·카드·지도 공통)
    cause: '해발 고도가 높아질수록 기온이 내려가(약 100m당 0.6℃), 저위도라도 연중 서늘하다.',
